...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="logout.php">Logout - Sair</a></li>
        </ul>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h2>Sistema de Gestão para Instituições e Organizações de Adoção de Animal </h2>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Serviços</h2>
          <p> Os serviços disponibilizados na aplicação são: </p>
        </div>
